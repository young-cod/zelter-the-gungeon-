...
void D2DRenderer::BeginRender(const D2D1::ColorF& backgroundColor)
{
	...
	D2DRenderer::GetInstance()->GetBackBuffer()->BeginDraw();
	D2DRenderer::GetInstance()->GetBackBuffer()->Clear();
}
/*****************************************************
## EndRender ##
*******************************************************/
void D2DRenderer::EndRender()
{
	...
	D2DRenderer::GetInstance()->GetBackBuffer()->EndDraw();
...
void D2DRenderer::CreateRenderTarget()
{
	...
	(
		D2D1::SizeF(BACKGROUNDX, BACKGROUNDY),
		&target
	);
